...
public class Reservation_CarVO {
	...
	public String getDriver_kind() {
		return driver_kind;
	}
	public void setDriver_kind(String driver_kind) {
		this.driver_kind = driver_kind;
	}
